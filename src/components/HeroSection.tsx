...
export function HeroSection() {
  return (
    <section className="text-center flex flex-col gap-4 sm:gap-5">
      ...
      <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-white via-indigo-100 to-purple-200 bg-clip-text text-transparent leading-tight max-w-3xl mx-auto text-balance">
        Uzun Metinleri Saniyeler İçinde Anlaşılır Özetlere Dönüştürün
      </h1>

      <p className="text-slate-300 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed text-pretty">
        Makaleleri, ders notlarını veya raporları saniyeler içinde 3–5 cümlelik net özetlere ve ana maddelere dönüştürün. Kayıt gerekmez, %100 ücretsizdir.
      </p>

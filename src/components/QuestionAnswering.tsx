...
export const QuestionAnswering = memo(function QuestionAnswering() {
  ...
  return (
    <div ref={qaSectionRef} className="glass-card rounded-2xl p-6 sm:p-7 border border-purple-500/35 shadow-2xl flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-2">
        <div className="text-xs font-semibold text-slate-400 flex items-center gap-1.5">
          <HelpCircle className="size-3.5 text-purple-400" aria-hidden="true" />
      ...
      <div className="flex flex-col gap-3">
        <div className="flex flex-col sm:flex-row gap-2.5">
          ...
          >
            {isAsking ? (
              <>
                <RefreshCw className="size-4 animate-spin text-purple-200" aria-hidden="true" />
      ...
      {/* Q&A Chat History */}
      {qaList.length > 0 && (
        <div role="log" aria-live="polite" aria-label="Soru ve yanıt geçmişi" className="flex flex-col gap-3.5 pt-4 border-t border-slate-800/80">
          ...
          <div className="flex flex-col gap-3.5">
            {qaList.map((item) => (
              <div
                key={item.id}
                className="glass-card rounded-xl p-4 border border-slate-700/80 flex flex-col gap-3 animate-in fade-in duration-300"
              >
